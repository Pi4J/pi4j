package com.pi4j.plugin.ffm2.gpio.enums;
 ...
 */
public enum LineAttributeId implements NativeMemoryLayout {
	/**
	...
	public LineAttributeId fromBytes(MemorySegment buffer) throws Throwable {
