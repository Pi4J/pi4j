...
public interface AnalogInputProvider extends AnalogProvider<AnalogInputProvider, AnalogInput, AnalogInputConfig> {
     ...
     * @return a T object.
     */
    default <T extends AnalogInput> T create(Integer pin) {
     ...
     * @return a T object.
     */
    default <T extends AnalogInput> T create(Integer pin, String id) {
        var builder = AnalogInputConfigBuilder.newInstance(context());
     ...
     * @return a T object.
     */
    default <T extends AnalogInput> T create(Integer pin, String id, String name) {
        var builder = AnalogInputConfigBuilder.newInstance(context());
     ...
     * @return a T object.
     */
    default <T extends AnalogInput> T create(Integer pin, String id, String name, String description) {
        var builder = AnalogInputConfigBuilder.newInstance(context());
